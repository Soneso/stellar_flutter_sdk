...
| [Stream payments](documentation/sdk_examples/stream_payments.md)                                         | Listens for payments received by a given account.                                                                                                                                                                                                     | [Streaming](https://developers.stellar.org/docs/data/apis/horizon/api-reference/structure/streaming)                                                                                                                                                                                                 |
...
| [SEP-0045: Web Authentication for Contract Accounts](documentation/sdk_examples/sep-0045-webauth-contracts.md)        | This example shows how to authenticate contract accounts (C... addresses) with web services using Soroban authorization entries.                                                                                                                      | [SEP-0045](https://github.com/stellar/stellar-protocol/blob/master/ecosystem/sep-0045.md)                                                                                                                                                                                                            |
| [SEP-0053: Sign and Verify Messages](documentation/sdk_examples/sep-0053.md)                             | This example shows how to sign and verify arbitrary messages using Stellar Ed25519 keypairs as defined by SEP-53.                                                                                                                                     | [SEP-0053](https://github.com/stellar/stellar-protocol/blob/master/ecosystem/sep-0053.md)                                                                                                                                                                                                            |
