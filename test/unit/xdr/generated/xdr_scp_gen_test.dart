...
void main() {
  group('XDR scp generated tests', () {
    ...
    test('XdrSCPNomination struct roundtrip', () {
      ...
      expect(
        base64Decoded.quorumSetHash.hash,
        equals(original.quorumSetHash.hash),
      );
    });
    ...
    test('XdrSCPStatementExternalize struct roundtrip', () {
      ...
      expect(decoded.nH.uint32, equals(original.nH.uint32));
      expect(
        decoded.commitQuorumSetHash.hash,
        equals(original.commitQuorumSetHash.hash),
      );
      ...
      expect(base64Decoded.nH.uint32, equals(original.nH.uint32));
      expect(
        base64Decoded.commitQuorumSetHash.hash,
        equals(original.commitQuorumSetHash.hash),
      );
    });

    test(
      'XdrSCPStatementPledges XdrSCPStatementType.SCP_ST_PREPARE arm roundtrip',
      () {
    ...
    test(
      'XdrSCPStatementPledges XdrSCPStatementType.SCP_ST_CONFIRM arm roundtrip',
      () {
        var original = XdrSCPStatementPledges(
          XdrSCPStatementType.SCP_ST_CONFIRM,
        );
    ...
    test(
      'XdrSCPStatementPledges XdrSCPStatementType.SCP_ST_EXTERNALIZE arm roundtrip',
      () {
        var original = XdrSCPStatementPledges(
          XdrSCPStatementType.SCP_ST_EXTERNALIZE,
        );
    ...
    test(
      'XdrSCPStatementPledges XdrSCPStatementType.SCP_ST_NOMINATE arm roundtrip',
      () {
        var original = XdrSCPStatementPledges(
          XdrSCPStatementType.SCP_ST_NOMINATE,
        );
