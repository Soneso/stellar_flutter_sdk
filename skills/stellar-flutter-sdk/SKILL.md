...
license: Apache 2.0
compatibility: Requires Dart SDK >=3.8.0 <4.0.0 and stellar_flutter_sdk ^3.1.0
metadata:
  version: "1.0.3"
  sdk_version: "3.1.0"
---
...
For contract authorization, multi-auth workflows, protocol 27 credentials (ADDRESS_V2 / WITH_DELEGATES), and low-level deploy/invoke:
