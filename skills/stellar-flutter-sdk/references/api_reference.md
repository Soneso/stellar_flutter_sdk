...
**Stats:** 673 classes, 4429 members
...
Future<List<int>> resolveContextRuleIdsForEntry(XdrSorobanAuthorizationEntry entry, List<OZSmartAccountSigner> signers, List<Object> contextRules,) async
...
bool operator ==(Object other)
## OZIndexerClient
OZIndexerClient(this._indexerUrl)
...
static OZIndexerClient? forNetwork(String networkPassphrase)
...
final String status
const OZIndexerHealthCheckResponse()
...
Uint8List toAuthPayloadBytes()
## OZRelayerClient
OZRelayerClient(this._relayerUrl)
OZRelayerClient.withDio(this._relayerUrl, this._dio)
Future<OZRelayerResponse> send(XdrHostFunction hostFunction, List<XdrSorobanAuthorizationEntry> authEntries)
Future<OZRelayerResponse> sendXdr(XdrTransactionEnvelope transactionEnvelope)
Future<void> close() async
## OZRelayerErrorCodes
...
static WebAuthnNotSupported notSupported()
static WebAuthnCancelled cancelled()
...
const ContractSpecException(this.message)
...
Future<GetTransactionResponse> pollTransaction(String hash)
void close()
