...
**Stats:** 669 classes, 4380 members
...
static Future<Uint8List> buildSourceAccountAuthPayloadHash(XdrSorobanAuthorizationEntry entry, XdrInt64 nonce, int expirationLedger, String networkPassphrase,) async
...
MethodOptions({this.fee = NetworkConstants.DEFAULT_SOROBAN_BASE_FEE, this.timeoutInSeconds = NetworkConstants.DEFAULT_TIMEOUT_SECONDS, this.simulate = true, this.restore = false, this.useUpgradedAuth = false})
## NativeUnionVal
final String tag
...
String? authMode
bool useUpgradedAuth
SimulateTransactionRequest(this.transaction, {this.resourceConfig, this.authMode, this.useUpgradedAuth = false})
Map<String, dynamic> getRequestArgs()
