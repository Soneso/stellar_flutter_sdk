...
class TradeResponse extends Response {
  ...
  factory TradeResponse.fromJson(Map<String, dynamic> json) => new TradeResponse(
      json['id'] as String,
      ...
      json['counter_account'] == null ? null : json['counter_account'] as String,
      ...
      json['price'] == null ? null : new Price.fromJson(json['price'] as Map<String, dynamic>))
    ..rateLimitLimit = convertInt(json['rateLimitLimit'])
    ..rateLimitRemaining = convertInt(json['rateLimitRemaining'])
    ..rateLimitReset = convertInt(json['rateLimitReset'])
    ..links = json['_links'] == null
        ? null
        : new TradeResponseLinks.fromJson(json['_links'] as Map<String, dynamic>);
}
...
class TradeResponseLinks {
  ...
  factory TradeResponseLinks.fromJson(Map<String, dynamic> json) => new TradeResponseLinks(
      json['base'] == null ? null : new Link.fromJson(json['base'] as Map<String, dynamic>),
      json['counter'] == null ? null : new Link.fromJson(json['counter'] as Map<String, dynamic>),
      json['operation'] == null
          ? null
