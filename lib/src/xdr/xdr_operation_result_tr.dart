...
class XdrOperationResultTr {
  ...
  void toTxRep(String prefix, List<String> lines) {
    ...
    switch (discriminant) {
      ...
      case XdrOperationType.PAYMENT:
        ...
        break;
      case XdrOperationType.PATH_PAYMENT_STRICT_RECEIVE:
        _pathPaymentStrictReceiveResult!.toTxRep(
          '$prefix.pathPaymentStrictReceiveResult',
          lines,
        );
        break;
      case XdrOperationType.MANAGE_SELL_OFFER:
        ...
        break;
      case XdrOperationType.CREATE_PASSIVE_SELL_OFFER:
        _createPassiveSellOfferResult!.toTxRep(
          '$prefix.createPassiveSellOfferResult',
          lines,
        );
        break;
      case XdrOperationType.SET_OPTIONS:
      ...
      case XdrOperationType.MANAGE_BUY_OFFER:
        ...
        break;
      case XdrOperationType.PATH_PAYMENT_STRICT_SEND:
        _pathPaymentStrictSendResult!.toTxRep(
          '$prefix.pathPaymentStrictSendResult',
          lines,
        );
        break;
      case XdrOperationType.CREATE_CLAIMABLE_BALANCE:
        _createClaimableBalanceResult!.toTxRep(
          '$prefix.createClaimableBalanceResult',
          lines,
        );
        break;
      case XdrOperationType.CLAIM_CLAIMABLE_BALANCE:
        _claimClaimableBalanceResult!.toTxRep(
          '$prefix.claimClaimableBalanceResult',
          lines,
        );
        break;
      case XdrOperationType.BEGIN_SPONSORING_FUTURE_RESERVES:
        _beginSponsoringFutureReservesResult!.toTxRep(
          '$prefix.beginSponsoringFutureReservesResult',
          lines,
        );
        break;
      case XdrOperationType.END_SPONSORING_FUTURE_RESERVES:
        _endSponsoringFutureReservesResult!.toTxRep(
          '$prefix.endSponsoringFutureReservesResult',
          lines,
        );
        break;
      case XdrOperationType.REVOKE_SPONSORSHIP:
        _revokeSponsorshipResult!.toTxRep(
          '$prefix.revokeSponsorshipResult',
          lines,
        );
        break;
      case XdrOperationType.CLAWBACK:
        ...
        break;
      case XdrOperationType.CLAWBACK_CLAIMABLE_BALANCE:
        _clawbackClaimableBalanceResult!.toTxRep(
          '$prefix.clawbackClaimableBalanceResult',
          lines,
        );
        break;
      case XdrOperationType.SET_TRUST_LINE_FLAGS:
        _setTrustLineFlagsResult!.toTxRep(
          '$prefix.setTrustLineFlagsResult',
          lines,
        );
        break;
      case XdrOperationType.LIQUIDITY_POOL_DEPOSIT:
        _liquidityPoolDepositResult!.toTxRep(
          '$prefix.liquidityPoolDepositResult',
          lines,
        );
        break;
      case XdrOperationType.LIQUIDITY_POOL_WITHDRAW:
        _liquidityPoolWithdrawResult!.toTxRep(
          '$prefix.liquidityPoolWithdrawResult',
          lines,
        );
        break;
      case XdrOperationType.INVOKE_HOST_FUNCTION:
        _invokeHostFunctionResult!.toTxRep(
          '$prefix.invokeHostFunctionResult',
          lines,
        );
        break;
      case XdrOperationType.EXTEND_FOOTPRINT_TTL:
        _extendFootprintTTLResult!.toTxRep(
          '$prefix.extendFootprintTTLResult',
          lines,
        );
        break;
      case XdrOperationType.RESTORE_FOOTPRINT:
        _restoreFootprintResult!.toTxRep(
          '$prefix.restoreFootprintResult',
          lines,
        );
        break;
      default:
  ...
  static XdrOperationResultTr fromTxRep(
    ...
    switch (result.discriminant) {
      case XdrOperationType.CREATE_ACCOUNT:
        result._createAccountResult = XdrCreateAccountResult.fromTxRep(
          map,
          '$prefix.createAccountResult',
        );
        break;
      case XdrOperationType.PAYMENT:
        result._paymentResult = XdrPaymentResult.fromTxRep(
          map,
          '$prefix.paymentResult',
        );
        break;
      case XdrOperationType.PATH_PAYMENT_STRICT_RECEIVE:
        result._pathPaymentStrictReceiveResult =
            XdrPathPaymentStrictReceiveResult.fromTxRep(
              map,
              '$prefix.pathPaymentStrictReceiveResult',
            );
        break;
      case XdrOperationType.MANAGE_SELL_OFFER:
        result._manageSellOfferResult = XdrManageOfferResult.fromTxRep(
          map,
          '$prefix.manageSellOfferResult',
        );
        break;
      case XdrOperationType.CREATE_PASSIVE_SELL_OFFER:
        result._createPassiveSellOfferResult = XdrManageOfferResult.fromTxRep(
          map,
          '$prefix.createPassiveSellOfferResult',
        );
        break;
      case XdrOperationType.SET_OPTIONS:
        result._setOptionsResult = XdrSetOptionsResult.fromTxRep(
          map,
          '$prefix.setOptionsResult',
        );
        break;
      case XdrOperationType.CHANGE_TRUST:
        result._changeTrustResult = XdrChangeTrustResult.fromTxRep(
          map,
          '$prefix.changeTrustResult',
        );
        break;
      case XdrOperationType.ALLOW_TRUST:
        result._allowTrustResult = XdrAllowTrustResult.fromTxRep(
          map,
          '$prefix.allowTrustResult',
        );
        break;
      case XdrOperationType.ACCOUNT_MERGE:
        result._accountMergeResult = XdrAccountMergeResult.fromTxRep(
          map,
          '$prefix.accountMergeResult',
        );
        break;
      case XdrOperationType.INFLATION:
        result._inflationResult = XdrInflationResult.fromTxRep(
          map,
          '$prefix.inflationResult',
        );
        break;
      case XdrOperationType.MANAGE_DATA:
        result._manageDataResult = XdrManageDataResult.fromTxRep(
          map,
          '$prefix.manageDataResult',
        );
        break;
      case XdrOperationType.BUMP_SEQUENCE:
        result._bumpSeqResult = XdrBumpSequenceResult.fromTxRep(
          map,
          '$prefix.bumpSeqResult',
        );
        break;
      case XdrOperationType.MANAGE_BUY_OFFER:
        result._manageBuyOfferResult = XdrManageOfferResult.fromTxRep(
          map,
          '$prefix.manageBuyOfferResult',
        );
        break;
      case XdrOperationType.PATH_PAYMENT_STRICT_SEND:
        result._pathPaymentStrictSendResult =
            XdrPathPaymentStrictSendResult.fromTxRep(
              map,
              '$prefix.pathPaymentStrictSendResult',
            );
        break;
      case XdrOperationType.CREATE_CLAIMABLE_BALANCE:
        result._createClaimableBalanceResult =
            XdrCreateClaimableBalanceResult.fromTxRep(
              map,
              '$prefix.createClaimableBalanceResult',
            );
        break;
      case XdrOperationType.CLAIM_CLAIMABLE_BALANCE:
        result._claimClaimableBalanceResult =
            XdrClaimClaimableBalanceResult.fromTxRep(
              map,
              '$prefix.claimClaimableBalanceResult',
            );
        break;
      case XdrOperationType.BEGIN_SPONSORING_FUTURE_RESERVES:
        result._beginSponsoringFutureReservesResult =
            XdrBeginSponsoringFutureReservesResult.fromTxRep(
              map,
              '$prefix.beginSponsoringFutureReservesResult',
            );
        break;
      case XdrOperationType.END_SPONSORING_FUTURE_RESERVES:
        result._endSponsoringFutureReservesResult =
            XdrEndSponsoringFutureReservesResult.fromTxRep(
              map,
              '$prefix.endSponsoringFutureReservesResult',
            );
        break;
      case XdrOperationType.REVOKE_SPONSORSHIP:
        result._revokeSponsorshipResult = XdrRevokeSponsorshipResult.fromTxRep(
          map,
          '$prefix.revokeSponsorshipResult',
        );
        break;
      case XdrOperationType.CLAWBACK:
        result._clawbackResult = XdrClawbackResult.fromTxRep(
          map,
          '$prefix.clawbackResult',
        );
        break;
      case XdrOperationType.CLAWBACK_CLAIMABLE_BALANCE:
        result._clawbackClaimableBalanceResult =
            XdrClawbackClaimableBalanceResult.fromTxRep(
              map,
              '$prefix.clawbackClaimableBalanceResult',
            );
        break;
      case XdrOperationType.SET_TRUST_LINE_FLAGS:
        result._setTrustLineFlagsResult = XdrSetTrustLineFlagsResult.fromTxRep(
          map,
          '$prefix.setTrustLineFlagsResult',
        );
        break;
      case XdrOperationType.LIQUIDITY_POOL_DEPOSIT:
        result._liquidityPoolDepositResult =
            XdrLiquidityPoolDepositResult.fromTxRep(
              map,
              '$prefix.liquidityPoolDepositResult',
            );
        break;
      case XdrOperationType.LIQUIDITY_POOL_WITHDRAW:
        result._liquidityPoolWithdrawResult =
            XdrLiquidityPoolWithdrawResult.fromTxRep(
              map,
              '$prefix.liquidityPoolWithdrawResult',
            );
        break;
      case XdrOperationType.INVOKE_HOST_FUNCTION:
        result._invokeHostFunctionResult =
            XdrInvokeHostFunctionResult.fromTxRep(
              map,
              '$prefix.invokeHostFunctionResult',
            );
        break;
      case XdrOperationType.EXTEND_FOOTPRINT_TTL:
        result._extendFootprintTTLResult =
            XdrExtendFootprintTTLResult.fromTxRep(
              map,
              '$prefix.extendFootprintTTLResult',
            );
        break;
      case XdrOperationType.RESTORE_FOOTPRINT:
        result._restoreFootprintResult = XdrRestoreFootprintResult.fromTxRep(
          map,
          '$prefix.restoreFootprintResult',
        );
        break;
