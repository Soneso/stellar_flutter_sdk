...
class XdrSCPHistoryEntryV0 {
  ...
  static XdrSCPHistoryEntryV0 decode(XdrDataInputStream stream) {
    ...
    decodedSCPHistoryEntryV0.quorumSets = <XdrSCPQuorumSet?>[]..length = quorumSetsSize;
    for (int i = 0; i < quorumSetsSize; i++) {
...
class XdrTransactionHistoryEntry {
  ...
  static void encode(
      XdrDataOutputStream stream, XdrTransactionHistoryEntry encodedTransactionHistoryEntry) {
  ...
  static XdrTransactionHistoryEntry decode(XdrDataInputStream stream) {
    XdrTransactionHistoryEntry decodedTransactionHistoryEntry = XdrTransactionHistoryEntry();
    ...
    decodedTransactionHistoryEntry.ext = XdrTransactionHistoryEntryExt.decode(stream);
...
class XdrTransactionHistoryEntryExt {
  ...
  static void encode(
      XdrDataOutputStream stream, XdrTransactionHistoryEntryExt encodedTransactionHistoryEntryExt) {
...
class XdrTransactionHistoryResultEntry {
  ...
  static XdrTransactionHistoryResultEntry decode(XdrDataInputStream stream) {
    ...
    decodedTransactionHistoryResultEntry.txResultSet = XdrTransactionResultSet.decode(stream);
    decodedTransactionHistoryResultEntry.ext = XdrTransactionHistoryResultEntryExt.decode(stream);
