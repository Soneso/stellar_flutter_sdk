...
class XdrLedgerKeyConfigSetting {
  ...
  static void encode(XdrDataOutputStream stream, XdrLedgerKeyConfigSetting encodedLedgerKeyConfigSetting) {
    XdrConfigSettingID.encode(stream, encodedLedgerKeyConfigSetting.configSettingID);
  }
