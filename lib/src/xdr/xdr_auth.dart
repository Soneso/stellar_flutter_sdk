...
class XdrAuthenticatedMessage {
  ...
  static void encode(
      XdrDataOutputStream stream, XdrAuthenticatedMessage encodedAuthenticatedMessage) {
  ...
  static XdrAuthenticatedMessage decode(XdrDataInputStream stream) {
    XdrAuthenticatedMessage decodedAuthenticatedMessage = XdrAuthenticatedMessage();
...
class XdrAuthenticatedMessageV0 {
  ...
  static void encode(
      XdrDataOutputStream stream, XdrAuthenticatedMessageV0 encodedAuthenticatedMessageV0) {
  ...
  static XdrAuthenticatedMessageV0 decode(XdrDataInputStream stream) {
    XdrAuthenticatedMessageV0 decodedAuthenticatedMessageV0 = XdrAuthenticatedMessageV0();
