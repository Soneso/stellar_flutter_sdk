...
class XdrTransactionEnvelope {
  ...
  static void encode(
    XdrDataOutputStream stream,
    XdrTransactionEnvelope encodedEnvelope,
  ) {
...
class XdrSorobanTransactionMetaExtV1 {
  ...
  static void encode(
    XdrDataOutputStream stream,
    XdrSorobanTransactionMetaExtV1 encoded,
  ) {
...
class XdrSorobanTransactionMetaV2 {
  ...
  static void encode(
    XdrDataOutputStream stream,
    XdrSorobanTransactionMetaV2 encoded,
  ) {
    XdrSorobanTransactionMetaExt.encode(stream, encoded.ext);
...
class XdrSorobanTransactionData {
  ...
  static void encode(
    XdrDataOutputStream stream,
    XdrSorobanTransactionData encoded,
  ) {
...
class XdrSorobanAuthorizedFunction {
  ...
  static void encode(
    XdrDataOutputStream stream,
    XdrSorobanAuthorizedFunction encoded,
  ) {
