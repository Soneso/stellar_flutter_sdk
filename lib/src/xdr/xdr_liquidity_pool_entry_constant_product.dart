...
class XdrLiquidityPoolEntryConstantProduct {
  ...
  static XdrLiquidityPoolEntryConstantProduct fromBase64EncodedXdrString(String base64Encoded) {
    Uint8List bytes = base64Decode(base64Encoded);
    return XdrLiquidityPoolEntryConstantProduct.decode(XdrDataInputStream(bytes));
  }
  ...
  void toTxRep(String prefix, List<String> lines) {
    ...
    _poolSharesTrustLineCount.toTxRep('$prefix.poolSharesTrustLineCount', lines);
  }

  static XdrLiquidityPoolEntryConstantProduct fromTxRep(Map<String, String> map, String prefix) {
    XdrLiquidityPoolConstantProductParameters params = XdrLiquidityPoolConstantProductParameters.fromTxRep(map, '$prefix.params');
    XdrInt64 reserveA = XdrInt64.fromTxRep(map, '$prefix.reserveA');
    XdrInt64 reserveB = XdrInt64.fromTxRep(map, '$prefix.reserveB');
    XdrInt64 totalPoolShares = XdrInt64.fromTxRep(map, '$prefix.totalPoolShares');
    XdrInt64 poolSharesTrustLineCount = XdrInt64.fromTxRep(map, '$prefix.poolSharesTrustLineCount');
    return XdrLiquidityPoolEntryConstantProduct(params, reserveA, reserveB, totalPoolShares, poolSharesTrustLineCount);
  }
}
