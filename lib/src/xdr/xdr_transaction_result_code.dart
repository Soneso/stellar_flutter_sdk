...
class XdrTransactionResultCode {
  ...
  static const txFROZEN_KEY_ACCESSED = const XdrTransactionResultCode._internal(-18);
  ...
  static XdrTransactionResultCode fromBase64EncodedXdrString(String base64Encoded) {
  ...
  String enumName() {
    switch (_value) {
      ...
      case -17: return 'txSOROBAN_INVALID';
      case -18: return 'txFROZEN_KEY_ACCESSED';
      default: return 'XdrTransactionResultCode#$_value';
    }
  }

  static XdrTransactionResultCode fromTxRep(Map<String, String> map, String prefix) {
  ...
  static XdrTransactionResultCode fromTxRepName(String name) {
    switch (name) {
      case 'txFEE_BUMP_INNER_SUCCESS': return txFEE_BUMP_INNER_SUCCESS;
      case 'txSUCCESS': return txSUCCESS;
      case 'txFAILED': return txFAILED;
      case 'txTOO_EARLY': return txTOO_EARLY;
      case 'txTOO_LATE': return txTOO_LATE;
      case 'txMISSING_OPERATION': return txMISSING_OPERATION;
      case 'txBAD_SEQ': return txBAD_SEQ;
      case 'txBAD_AUTH': return txBAD_AUTH;
      case 'txINSUFFICIENT_BALANCE': return txINSUFFICIENT_BALANCE;
      case 'txNO_ACCOUNT': return txNO_ACCOUNT;
      case 'txINSUFFICIENT_FEE': return txINSUFFICIENT_FEE;
      case 'txBAD_AUTH_EXTRA': return txBAD_AUTH_EXTRA;
      case 'txINTERNAL_ERROR': return txINTERNAL_ERROR;
      case 'txNOT_SUPPORTED': return txNOT_SUPPORTED;
      case 'txFEE_BUMP_INNER_FAILED': return txFEE_BUMP_INNER_FAILED;
      case 'txBAD_SPONSORSHIP': return txBAD_SPONSORSHIP;
      case 'txBAD_MIN_SEQ_AGE_OR_GAP': return txBAD_MIN_SEQ_AGE_OR_GAP;
      case 'txMALFORMED': return txMALFORMED;
      case 'txSOROBAN_INVALID': return txSOROBAN_INVALID;
      case 'txFROZEN_KEY_ACCESSED': return txFROZEN_KEY_ACCESSED;
      default:
        if (name.startsWith('XdrTransactionResultCode#')) {
          int? val = int.tryParse(name.substring('XdrTransactionResultCode#'.length));
