...
class XdrAssetType {
  ...
  static XdrAssetType fromXdrJson(String json) => fromXdrJsonValue(
    XdrJsonHelper.decodeDocument(json, type: 'XdrAssetType'),
  );
  ...
  Object? toXdrJsonValue() {
    switch (_value) {
      ...
      case 3:
        return 'pool_share';
      default:
        XdrJsonHelper.fail('XdrAssetType', 'holds the unknown value $_value');
    }
  }
