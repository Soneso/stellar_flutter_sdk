...
class XdrTransactionV1Envelope {
  ...
  static void encode(XdrDataOutputStream stream, XdrTransactionV1Envelope encodedTransactionV1Envelope) {
    ...
    for (int i = 0; i < signaturessize; i++) {
      XdrDecoratedSignature.encode(stream, encodedTransactionV1Envelope.signatures[i]);
    }
  }
  ...
  static XdrTransactionV1Envelope fromBase64EncodedXdrString(String base64Encoded) {
  ...
  static XdrTransactionV1Envelope fromTxRep(Map<String, String> map, String prefix) {
