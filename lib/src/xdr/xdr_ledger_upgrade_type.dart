...
class XdrLedgerUpgradeType {
  ...
  String enumName() {
    switch (_value) {
      ...
      case 6: return 'LEDGER_UPGRADE_CONFIG';
      case 7: return 'LEDGER_UPGRADE_MAX_SOROBAN_TX_SET_SIZE';
      default: return 'XdrLedgerUpgradeType#$_value';
    }
  }

  static XdrLedgerUpgradeType fromTxRep(Map<String, String> map, String prefix) {
  ...
  static XdrLedgerUpgradeType fromTxRepName(String name) {
    switch (name) {
      case 'LEDGER_UPGRADE_VERSION': return LEDGER_UPGRADE_VERSION;
      case 'LEDGER_UPGRADE_BASE_FEE': return LEDGER_UPGRADE_BASE_FEE;
      case 'LEDGER_UPGRADE_MAX_TX_SET_SIZE': return LEDGER_UPGRADE_MAX_TX_SET_SIZE;
      case 'LEDGER_UPGRADE_BASE_RESERVE': return LEDGER_UPGRADE_BASE_RESERVE;
      case 'LEDGER_UPGRADE_FLAGS': return LEDGER_UPGRADE_FLAGS;
      case 'LEDGER_UPGRADE_CONFIG': return LEDGER_UPGRADE_CONFIG;
      case 'LEDGER_UPGRADE_MAX_SOROBAN_TX_SET_SIZE': return LEDGER_UPGRADE_MAX_SOROBAN_TX_SET_SIZE;
      default:
        if (name.startsWith('XdrLedgerUpgradeType#')) {
          int? val = int.tryParse(name.substring('XdrLedgerUpgradeType#'.length));
