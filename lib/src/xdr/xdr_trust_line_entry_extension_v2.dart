...
class XdrTrustLineEntryExtensionV2 {
  ...
  String toXdrJson() => XdrJsonHelper.encodeDocument(
    toXdrJsonValue(),
    type: 'XdrTrustLineEntryExtensionV2',
  );

  /// Parses the SEP-0051 XDR-JSON rendering of a XdrTrustLineEntryExtensionV2.
  static XdrTrustLineEntryExtensionV2 fromXdrJson(String json) =>
      fromXdrJsonValue(
  ...
  /// Returns the SEP-0051 rendering of this XdrTrustLineEntryExtensionV2.
  Object? toXdrJsonValue() => <String, Object?>{
    'liquidity_pool_use_count': _liquidityPoolUseCount.toXdrJsonValue(),
    'ext': _ext.toXdrJsonValue(),
  };

  /// Reads a XdrTrustLineEntryExtensionV2 from its SEP-0051 rendering.
  static XdrTrustLineEntryExtensionV2 fromXdrJsonValue(Object? value) {
    final Map<String, dynamic> object = XdrJsonHelper.readObject(
      value,
      type: 'XdrTrustLineEntryExtensionV2',
      allowedKeys: const <String>{'liquidity_pool_use_count', 'ext'},
    );
    final Object? jsonLiquidityPoolUseCount = XdrJsonHelper.readField(
      object,
    ...
    return XdrTrustLineEntryExtensionV2(
      XdrInt32.fromXdrJsonValue(jsonLiquidityPoolUseCount),
      XdrTrustLineEntryExtensionV2Ext.fromXdrJsonValue(jsonExt),
    );
  }
}
