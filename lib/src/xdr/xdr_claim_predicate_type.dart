...
class XdrClaimPredicateType {
  ...
  String toBase64EncodedXdrString() {
    ...
    XdrClaimPredicateType.encode(xdrOutputStream, this);
  ...
  String enumName() {
    switch (_value) {
      ...
      case 5:
        return 'CLAIM_PREDICATE_BEFORE_RELATIVE_TIME';
      default:
        return 'XdrClaimPredicateType#$_value';
    }
  }

  static XdrClaimPredicateType fromTxRep(
      ...
      default:
        if (name.startsWith('XdrClaimPredicateType#')) {
          int? val = int.tryParse(
            name.substring('XdrClaimPredicateType#'.length),
          );
