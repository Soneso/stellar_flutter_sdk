...
class XdrContractExecutableBase {
  ...
  set externalRef(XdrContractExecutableExternalRef? value) =>
  ...
  static void encode(
    ...
    switch (encodedContractExecutable.discriminant) {
      ...
      case XdrContractExecutableType.CONTRACT_EXECUTABLE_EXTERNAL_REF:
        XdrContractExecutableExternalRef.encode(
          stream,
          encodedContractExecutable._externalRef!,
        );
        break;
      default:
        break;
  ...
  static XdrContractExecutableBase fromTxRep(
    ...
    switch (result.discriminant) {
      ...
      case XdrContractExecutableType.CONTRACT_EXECUTABLE_STELLAR_ASSET:
        break;
      case XdrContractExecutableType.CONTRACT_EXECUTABLE_EXTERNAL_REF:
        result._externalRef = XdrContractExecutableExternalRef.fromTxRep(
          map,
          '$prefix.external_ref',
        );
        break;
