    ...
    switch (encodedClaimPredicate.discriminant) {
      ...
      case XdrClaimPredicateType.CLAIM_PREDICATE_AND:
        ...
        for (int i = 0; i < pSize; i++) {
          XdrClaimPredicate.encode(stream, encodedClaimPredicate.andPredicates![i]!);
        }
        break;
      case XdrClaimPredicateType.CLAIM_PREDICATE_OR:
        ...
        stream.writeInt(pSize);
        for (int i = 0; i < pSize; i++) {
          XdrClaimPredicate.encode(stream, encodedClaimPredicate.orPredicates![i]!);
        }
        break;
...
class XdrClaimableBalanceID {
  ...
  static void encode(XdrDataOutputStream stream, XdrClaimableBalanceID encoded) {
  ...
  static XdrClaimableBalanceID decode(XdrDataInputStream stream) {
    ...
    XdrClaimableBalanceIDType discriminant = XdrClaimableBalanceIDType.decode(stream);
    decoded.discriminant = discriminant;
    switch (decoded.discriminant) {
      case XdrClaimableBalanceIDType.CLAIMABLE_BALANCE_ID_TYPE_V0:
...
class XdrClaimableBalanceEntry {
  ...
  static void encode(XdrDataOutputStream stream, XdrClaimableBalanceEntry encoded) {
...
class XdrClaimableBalanceEntryExt {
  ...
  static void encode(XdrDataOutputStream stream, XdrClaimableBalanceEntryExt encoded) {
...
class XdrLedgerKeyOffer {
  ...
  static void encode(XdrDataOutputStream stream, XdrLedgerKeyOffer encodedLedgerKeyOffer) {
...
class XdrLedgerKeyData {
  ...
  static void encode(XdrDataOutputStream stream, XdrLedgerKeyData encodedLedgerKeyData) {
  ...
  static void encode(XdrDataOutputStream stream, XdrLedgerEntryData encodedLedgerEntryData) {
    ...
    switch (encodedLedgerEntryData.discriminant) {
      ...
      case XdrLedgerEntryType.DATA:
        ...
        break;
      case XdrLedgerEntryType.CLAIMABLE_BALANCE:
        XdrClaimableBalanceEntry.encode(stream, encodedLedgerEntryData.claimableBalance!);
        break;
    }
  }
...
class XdrLedgerEntryChanges {
  ...
  static void encode(XdrDataOutputStream stream, XdrLedgerEntryChanges encodedLedgerEntryChanges) {
    int ledgerEntryChangesSize = encodedLedgerEntryChanges.ledgerEntryChanges!.length;
  ...
  static XdrLedgerEntryChanges decode(XdrDataInputStream stream) {
    ...
    decodedLedgerEntryChanges.ledgerEntryChanges = []..length = ledgerEntryChangesSize;
    for (int i = 0; i < ledgerEntryChangesSize; i++) {
      decodedLedgerEntryChanges.ledgerEntryChanges![i] = XdrLedgerEntryChange.decode(stream);
    }
...
class XdrLedgerHeaderHistoryEntry {
  ...
  static void encode(
      XdrDataOutputStream stream, XdrLedgerHeaderHistoryEntry encodedLedgerHeaderHistoryEntry) {
  ...
  static XdrLedgerHeaderHistoryEntry decode(XdrDataInputStream stream) {
    XdrLedgerHeaderHistoryEntry decodedLedgerHeaderHistoryEntry = XdrLedgerHeaderHistoryEntry();
    ...
    decodedLedgerHeaderHistoryEntry.ext = XdrLedgerHeaderHistoryEntryExt.decode(stream);
