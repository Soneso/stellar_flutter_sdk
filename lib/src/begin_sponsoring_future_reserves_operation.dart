...
class BeginSponsoringFutureReservesOperation extends Operation {
  ...
  XdrOperationBody toOperationBody() {
    XdrBeginSponsoringFutureReservesOp op = XdrBeginSponsoringFutureReservesOp();

    XdrAccountID sponsoredAId = XdrAccountID();
    sponsoredAId.accountID = KeyPair.fromAccountId(this.sponsoredId).xdrPublicKey;
  ...
  static BeginSponsoringFutureReservesOperation builder(XdrBeginSponsoringFutureReservesOp op) {
    String sponsoredId = KeyPair.fromXdrPublicKey(op.sponsoredID!.accountID!).accountId;
