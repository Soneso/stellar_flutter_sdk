...
String txBase64Xdr = tx.toEnvelopeXdrBase64();
```
...
SDK's [SEP-08 test cases](https://github.com/Soneso/stellar_flutter_sdk/blob/master/test/integration/sep0008_test.dart).
